...
public class SendController {
    ...
    public String submitForm(@ModelAttribute("paymentRequestWrapper") PaymentRequestWrapper paymentRequestWrapper, RedirectAttributes redirectAttributes) throws Exception{
        TransferWrapper paymentResponse = service.makeCall(paymentRequestWrapper);

        ObjectMapper mapper = new ObjectMapper();
        //mapper.configOverride(Object.class).setIncludeAsProperty(JsonInclude.Value.construct(Include.NON_NULL, Include.NON_NULL));
